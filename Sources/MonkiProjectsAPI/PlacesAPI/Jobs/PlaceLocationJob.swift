...
public struct PlaceLocationJobPayload: Codable {
...
public struct PlaceLocationJob: Job {
	
	public typealias Payload = PlaceLocationJobPayload
	...
	public func dequeue(_ context: QueueContext, _ payload: Payload) -> EventLoopFuture<Void> {
		...
		return reverseGeocodingFuture
			...
			.flatMapThrowing { response, details -> PlaceModel.Location in
